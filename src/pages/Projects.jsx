...
export const Projects = () => {
  ...
  return (
    <section className="h-screen text-blue-500 bg-gray-600 font-NovaSquare pt-[60px] pb-4 overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-track-gray-400 scrollbar-thumb-slate-500" ref={section}>
